...
): Array<{ name: string; age: number; contact: { email: string; extension: number } }> {
    let result: Array<{ name: string; age: number; contact: { email: string; extension: number } }> = [];
